<template>
  <div class="max-w-4xl mx-auto p-6 bg-base-100 rounded-lg shadow-lg">
    ...
    <BaseModal v-if="isVisibleHistorySalaryModal">
...
import HistorySalaryModal from '@/components/salary/HistorySalaryModal.vue'
...
const fetchOvertimeList = async (userId) => {
  try {
    ...
    console.log('Danh sách overtime:', overtimeData)
    console.log('overtimeHours:', overtimeHours.value)
